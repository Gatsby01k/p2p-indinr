...
const PATHS: Readonly<Record<IconName, string>> = {
  ...
  rewards: 'M4 11h16v8.5a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1zM3 7.5h18V11H3zM12 7.5v13M12 7.5S10.6 3.5 8.3 3.5a2 2 0 0 0 0 4zM12 7.5s1.4-4 3.7-4a2 2 0 0 1 0 4z',
  ...
  'shield-check': 'M12 3.2 4.8 6v6c0 4.5 3 7.7 7.2 9.3 4.2-1.6 7.2-4.8 7.2-9.3V6zM8.9 11.9l2.2 2.2 4-4.4',
  ...
  message: 'M20.5 11.5c0 4-3.8 7.2-8.5 7.2-1 0-2-.15-2.9-.42L4 20l1.3-3.7A7 7 0 0 1 3.5 11.5c0-4 3.8-7.2 8.5-7.2s8.5 3.2 8.5 7.2z',
  clock: 'M20.5 12a8.5 8.5 0 1 1-17 0 8.5 8.5 0 0 1 17 0zM12 7.2V12l3.2 2',
  alert: 'M12 8.5V13m0 3.2v.1M10.3 4.4 2.9 17.2A1.5 1.5 0 0 0 4.2 19.5h15.6a1.5 1.5 0 0 0 1.3-2.3L13.7 4.4a2 2 0 0 0-3.4 0z',
  ...
  logout: 'M15 8V5.5A1.5 1.5 0 0 0 13.5 4h-8A1.5 1.5 0 0 0 4 5.5v13A1.5 1.5 0 0 0 5.5 20h8a1.5 1.5 0 0 0 1.5-1.5V16m2.5-8L21 12l-3.5 4M20 12H9',
  star: 'm12 3.8 2.6 5.3 5.9.9-4.25 4.15 1 5.85L12 17.25 6.75 20l1-5.85L3.5 10l5.9-.9z',
  users: 'M15.5 20.5v-1.8a4 4 0 0 0-4-4h-4a4 4 0 0 0-4 4v1.8M13 7.2a3.7 3.7 0 1 1-7.4 0 3.7 3.7 0 0 1 7.4 0zM20.5 20.5v-1.8a4 4 0 0 0-3-3.87M16 3.7a4 4 0 0 1 0 7.75',
  wallet:
  ...
  trash: 'M4.5 6.5h15M9.5 6.5V4.8a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v1.7M6.5 6.5l.8 12.2a1.5 1.5 0 0 0 1.5 1.4h6.4a1.5 1.5 0 0 0 1.5-1.4l.8-12.2M10 10.5v6m4-6v6',
  ...
  sparkle: 'M12 3.5 13.6 9l5.4 1.6-5.4 1.6L12 17.6l-1.6-5.4L5 10.6 10.4 9zM18.5 16l.7 2.2 2.3.7-2.3.7-.7 2.2-.7-2.2-2.3-.7 2.3-.7z',
};
