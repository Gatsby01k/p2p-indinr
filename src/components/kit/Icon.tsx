...
const PATHS: Readonly<Record<IconName, string>> = {
  ...
  /* Reputation and rewards. Reputation is a PERSON plus evidence, never
     a medal — hence a figure with a tick rather than a trophy. */
  'user-check':
    'M11 11.8a3.9 3.9 0 1 0 0-7.8 3.9 3.9 0 0 0 0 7.8zM3.6 20.4a7.4 7.4 0 0 1 12.2-5.6M15.4 18.9l2 2 4.1-4.6',
  'user-plus':
    'M11 11.8a3.9 3.9 0 1 0 0-7.8 3.9 3.9 0 0 0 0 7.8zM3.6 20.4a7.4 7.4 0 0 1 12.3-5.5M18.6 14.8v6.2M21.7 17.9h-6.2',
  percent:
    'M8.6 6.8a2 2 0 1 1-4 0 2 2 0 0 1 4 0zM19.4 17.2a2 2 0 1 1-4 0 2 2 0 0 1 4 0zM18.6 5.4 5.4 18.6',
  tag: 'M11.4 3.6H5.1A1.5 1.5 0 0 0 3.6 5.1v6.3a1.5 1.5 0 0 0 .44 1.06l7.5 7.5a1.5 1.5 0 0 0 2.12 0l6.3-6.3a1.5 1.5 0 0 0 0-2.12l-7.5-7.5a1.5 1.5 0 0 0-1.06-.44zM7.7 7.7v.1',
  bolt: 'M13.6 3.2 5.9 13.4h5.2l-.7 7.4 7.7-10.2h-5.2z',
